package uk.gov.digital.ho.egar.gar.config;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("Gar API",                       // title
                "API for a Gar",                  // description
                "4.1.1",                                 // version
                "IPL Sample API terms of service",      // termsOfServiceUrl
                new Contact("",
                        "",
                        ""),     // contact
                "API Licence",                          // license
